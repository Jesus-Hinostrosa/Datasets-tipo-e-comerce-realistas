...
Se creo un dataset sintético con el código del archivo "data_ecomerce_dirty.ipynb" que simula las ventas de un e-comerce, en este dataset se incluyen los tres archivos:
